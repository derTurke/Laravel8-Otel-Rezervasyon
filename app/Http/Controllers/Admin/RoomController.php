...
class RoomController extends Controller
{
    ...
    public function create($hotel_id)
    {
        ...
        return view('admin.hotel_room_add',['data' => $data,'rooms' => $rooms]);
    }
    ...
    public function store(Request $request,$hotel_id)
    {
        ...
        $data->save();
        return redirect()->route('admin_room_add',['hotel_id' => $hotel_id])->with('success','');
    }
    ...
    {
        $data = Room::find($id);
        return view('admin.hotel_room_edit',['data' => $data, "hotel_id" => $hotel_id]);
    }
