...
<head>
    ...
    <title>Admin Hotel Update Room Page</title>
    ...
    <div class="card">
        <div class="card-body">
            <div class="p-4 border rounded">
                Hotel Update Room
                <hr>
                <form class="row g-3 needs-validation was-validated" novalidate="" action="{{route('admin_room_update',['id' => $data->id,'hotel_id' => $hotel_id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
