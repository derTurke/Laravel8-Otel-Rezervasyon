...
<head>
    ...
    <title>Admin Hotel Add Room Page</title>
    ...
    <div class="card">
        <div class="card-body">
            <div class="p-4 border rounded">
                Hotel Add Room
                <hr>
                <form class="row g-3 needs-validation was-validated" novalidate="" action="{{route('admin_room_store',['hotel_id' => $data->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                ...
                <table id="images" class="table table-striped table-bordered" style="width:100%">
                    ...
                    @foreach($rooms as $room)
                        <tr>
                            ...
                            <td>{{$room->status}}</td>
                            <td>
                                <a href="{{route('admin_room_edit',["id" => $room->id,"hotel_id" => $data->id])}}"><i class="bx bx-pencil text-primary font-24"></i></a>
                                <a href="{{route('admin_room_destroy',["id" => $room->id,"hotel_id" => $data->id])}}" onclick="return confirm('Delete! Are you sure?')"><i class="bx bx-trash text-danger font-24"></i></a>
                            </td>
                        </tr>
                    @endforeach
